controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    myBall2 = carnival.createProjectileBallFromSprite(assets.image`f`, myBall)
})
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.Enemy, function (sprite, otherSprite) {
    sprites.destroy(projectile)
    sprites.destroy(myBall2)
    info.changeScoreBy(1)
})
let projectile: Ball = null
...
scene.setBackgroundImage(img`
    ...
    `)
myBall = carnival.create(assets.image`f`, SpriteKind.Player)
myBall.scale = 2
myBall.setPosition(80, 102)
...
forever(function () {
    projectile = carnival.create(assets.image`g`, SpriteKind.Enemy)
    projectile.setVelocity(77, 0)
    projectile.bottom = 56
    projectile.setKind(SpriteKind.Enemy)
    pause(randint(2555, 4000))
})
